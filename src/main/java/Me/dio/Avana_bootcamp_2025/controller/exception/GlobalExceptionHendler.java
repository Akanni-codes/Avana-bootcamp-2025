...
public class GlobalExceptionHendler {
   ...
   private final Logger logger = LoggerFactory.getLogger(GlobalExceptionHendler.class);

    @ExceptionHandler(IllegalArgumentException.class)
    public ResponseEntity<String> handle(IllegalArgumentException businessExcepiton) {
        return new ResponseEntity<>(businessExcepiton.getMessage(), HttpStatus.UNPROCESSABLE_ENTITY);
    }
